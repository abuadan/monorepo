...
eslint = lint_eslint_aspect(
    ...
    configs = [
        label("//javascript/:eslintrc"),
        label("//typescript/:eslintrc"),
    ],
)
...
ktlint = lint_ktlint_aspect(
    ...
    baseline_file = Label("//jvm:ktlint-baseline.xml"),
)
